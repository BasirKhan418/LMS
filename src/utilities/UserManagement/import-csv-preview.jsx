...
export function ImportPreviewModal({ isOpen, onClose, data, onConfirm }) {
  ...
  const sortedKeys = ["name", "email", "domain", "ispaid", "gender", "phone", "duration"].concat(
    allKeys.filter((key) => !["name", "email", "domain", "ispaid", "gender", "phone", "duration", "id"].includes(key)),
  )
