...
const handleOtpSend = async(e)=>{
  ...
  try{
  setLoading(true);
   let data = await axios.post("/api/trainerauth",{email:email.toLowerCase(),type:"send"})
   setLoading(false)
...
setLoading(true);
let data = await axios.post("/api/trainerauth",{email:email.toLowerCase(),type:"verify",otp:otp})
   setLoading(false)
    if(data.data.success){
        setIsOtpsent(true);
        toast.success(data.data.message)
